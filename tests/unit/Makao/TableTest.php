...
class TableTest extends TestCase
{
    ...
    public function testShouldThrowCardNotFoundExceptionWhenGetPlayedCardColorOnEmptyTable(): void {
        // Expect
    ...
    public function testShouldReturnPlayedCardsColorSetByAddPlayedCard(): void {
        ...
        // Then
        $this->assertEquals(Card::COLOR_SPADE, $this->tableUnderTest->getPlayedCardColor());
    }
}
